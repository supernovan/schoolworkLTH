...
public class TestArraySet {
	...
	public final void testaddAll() {
		...
		boolean changed = s.addAll(s2);
		assertEquals("Incorrect return value from addAll: ", true, changed);
		assertEquals("Wrong size():", 10, s2.size());

		changed = s.addAll(new ArraySet<Integer>());
		assertEquals("Incorrect return value from addAll: ", false, changed);
