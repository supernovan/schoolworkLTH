...
public class TestE  {
    ...
    /*  
	 * represents number of fail paths 
     */
    int fail = 0;

     /*  
	 * represents number of total nodes 
     */
    int total_nodes = 0;
	...
	//total nodes checkedout increases here
	total_nodes++; 
	...
	System.out.println ("\n---------------");
	System.out.println("nbr searchnodes : " + total_nodes);
		System.out.println("nbr wrong decisions : " + fail);
    }
	 ...
	 */ 
	IntVar selectVariable(IntVar[] v, int index) { //byt till länkad lista?
	    
	    if (v.length != 0) {
	    	if (v[index].singleton()) {
